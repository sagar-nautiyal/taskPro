  ...
  try {
    ...
    const tasks = await Task.insertMany([
      // Inbox Tasks
      {
        ...
        description:
          "This is your first task. You can drag and drop tasks between columns to update their status.",
        userId: users[0]._id,
        status: "inbox",
      ...
      },
      {
        ...
        description:
          "Check out the modern dashboard with statistics and task overview.",
        userId: users[0]._id,
        status: "inbox",
        boardId: boards[0]._id,
      },
      ...
      },
      {
        ...
        description:
          "Set up a new board for your upcoming project and organize your workflow.",
        userId: users[0]._id,
        status: "todo",
      ...
      },
      {
        ...
        description:
          "TaskPro is now ready to use with modern design and cloud database!",
        userId: users[0]._id,
        status: "completed",
        boardId: boards[0]._id,
      },
