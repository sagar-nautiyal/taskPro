    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-100 to-blue-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Welcome to TaskPro</h1>
          <p className="text-slate-600 mb-8">Please login to access your dashboard</p>
        </div>
      </div>
    );
  }
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Organize • Collaborate • Achieve</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm border border-white/20 rounded-2xl shadow-xl shadow-black/5">
              <div className="p-6 border-b border-slate-100">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h2 className="text-lg font-semibold text-slate-900">Task Inbox</h2>
                </div>
                ...
                <div className="space-y-3 max-h-96 overflow-y-auto">
                  ...
                  {filteredTasks.length === 0 && searchTerm && (
                    <div className="text-center py-8">
                      ...
                      <p className="text-slate-500 text-sm">No tasks found matching "{searchTerm}"</p>
                    </div>
                  )}
                  {tasks.length === 0 && !searchTerm && (
                    <div className="text-center py-8">
                      ...
                      <p className="text-slate-400 text-xs">Create your first task below!</p>
                    </div>
                  )}
                </div>
                <div className="mt-6">
              ...
              <div className="p-6 border-b border-slate-100">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <h2 className="text-lg font-semibold text-slate-900">Project Boards</h2>
                  </div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {boards.length === 0 && (
                    <div className="text-slate-500 text-sm italic">No boards yet. Create your first board!</div>
                  )}
                </div>
              </div>
