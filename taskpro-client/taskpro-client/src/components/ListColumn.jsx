        ...
        {task.category && (
          <span className="category-tag">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
              <path d="M20.59 13.41L13.42 20.58C13.2343 20.766 13.0137 20.9135 12.7709 21.0141C12.5281 21.1148 12.2678 21.1666 12.005 21.1666C11.7422 21.1666 11.4819 21.1148 11.2391 21.0141C10.9963 20.9135 10.7757 20.766 10.59 20.58L2 12V2H12L20.59 10.59C20.9625 10.9647 21.1716 11.4716 21.1716 12.005C21.1716 12.5384 20.9625 13.0453 20.59 13.41V13.41Z" stroke="currentColor" strokeWidth="1.5"/>
...
export const ListColumn = ({ title, status, tasks, icon }) => {
  ...
  }), [currentBoard, status, dispatch]); // Add dependencies to recreate drop handler when board changes
    ...
    >
      <div className="column-header">
        <div className="column-title-wrapper">
          <div className="column-icon" style={{ color: getColumnColor(status) }}>
            {icon}
          </div>
      ...
      <div className="column-content">
        {tasks.length === 0 ? (
          <div className="empty-column">
            <div className="empty-icon" style={{ color: getColumnColor(status) }}>
              {icon}
            </div>
